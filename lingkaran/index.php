                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="index.php">Lingkaran</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title text-center">
                    <h1>Input Lingkaran</h1>
                </div>
                <form action="../action.php" method="POST">
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="form-label">Jari-Jari</label>
                        <input type="number" name="jari" required="" step="any" min="0" max="100" class="form-control"
                            value="<?= $jari ?>" />
                    </div>
                    <div class="form-group d-flex justify-content-end mt-3">
                        <?php if ($editmode == false): ?>
                        <button class="btn btn-primary" name="lingkaran" type="submit" value="tambah">Submit</button>
                        <!-- &nbsp;<button class="btn btn-secondary" type="reset">Reset</button> -->
                        <?php else: ?>
                        <input type="hidden" name="id" value="<?= $ID ?>" />
                        <button class="btn btn-primary" name="lingkaran" type="submit" value="edit">Edit</button>
