            ...
            <div class="card-body">
                ...
                <form action="../action.php" method="POST">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="alas" required="" step="any" min="0" max="100"
                                    class="form-control" value="<?= $alas ?>" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="form-label">Tinggi</label>
                                <input type="number" name="tinggi" step="any" min="0" max="100" class="form-control"
                                    value="<?= $tinggi ?>" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group d-flex justify-content-end mt-3">
                        ...
                        <button class="btn btn-primary" name="segitiga" type="submit" value="tambah">Submit</button>
                        &nbsp;
                        <?php else: ?>
                        <!-- <input type="hidden" name="id" value="<?= $ID ?>" />
                        <button class="btn btn-primary" name="segitiga" type="submit" value="edit">Edit</button>
